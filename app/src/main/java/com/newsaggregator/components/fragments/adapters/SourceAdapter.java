package com.newsaggregator.components.fragments.adapters;
...
public class SourceAdapter extends RecyclerView.Adapter<SourceAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(SourceAdapter.ViewHolder holder, int position) {
        ...
        ImageButton deleteButton = cardView.findViewById(R.id.source_delete_button);
        deleteButton.setOnClickListener(v -> {
            if (listener != null) {
                listener.deleteSource(channel.getDbSourceId());
            }
        });
    }
